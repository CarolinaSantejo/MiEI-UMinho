...
int createFileType (figure f, string name){
    ...
    file << f.normal.size() << "\n";
    for (point p : f.normal) {
        file << p.x << " ";
        file << p.y << " ";
        file << p.z << " ";
        file << "\n";
    }
    file << f.texCoord.size() << "\n";
    for (point p : f.texCoord) {
        file << p.x << " ";
        file << p.y << " ";
        file << "\n";
    }
