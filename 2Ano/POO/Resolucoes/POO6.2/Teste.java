...
public class Teste
{
    public static void main() throws ClassNotFoundException{
        ...
        System.out.println(drive.quantosT("VeiculoNormal"));
        //System.out.println(drive.getVeiculosList().toString());
        System.out.println("Custo real: " + drive.custoRealKm("00HB53"));
        System.out.println(drive.quantos("Opel"));
        System.out.println(drive.getVeiculosList());
    }
