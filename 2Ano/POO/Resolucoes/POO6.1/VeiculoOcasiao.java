...
public class VeiculoOcasiao extends Veiculo
{
    ...
    public VeiculoOcasiao(String mat, String marc, String mod, int ano, double vel, double preco, boolean desc) throws ValorInvalidoException {
        super(mat, marc, mod, ano, vel, preco);
        this.desconto = desc;
    }
    
    public VeiculoOcasiao(String mat, String marc, String mod, int ano, double vel, double preco, ArrayList<Integer> classif, int kms, int kmsUltimo, boolean desc) throws ValorInvalidoException {
