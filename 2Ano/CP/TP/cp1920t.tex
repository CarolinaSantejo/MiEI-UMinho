...
\\
\>[B]{}\Varid{discollect}\mathrel{=}\Varid{cataList}\;\alt{\Varid{nil}}{\uncurry{(\plus )}\comp (\Varid{k}\times\Varid{id})}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\mathbf{where}\;\Varid{k}\;(\Varid{a},[\mskip1.5mu \mskip1.5mu])\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[9]{}\hsindent{6}{}\<[15]%
\>[15]{}\Varid{k}\;(\Varid{a},\Varid{h}\mathbin{:}\Varid{l})\mathrel{=}\Varid{singl}\;(\Varid{a},\Varid{h})\plus \Varid{k}\;(\Varid{a},\Varid{l}){}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g1}\;\Varid{v}\mathrel{=}\Varid{singl}\;(\text{\tt \char34 \char34},\Varid{v}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g2}\;(\Varid{o},[\mskip1.5mu \mskip1.5mu])\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g2}\;(\Varid{o},\Varid{h}\mathbin{:}\Varid{t})\mathrel{=}\Varid{aux}\;(\Varid{o},\Varid{h})\plus \Varid{g2}\;(\Varid{o},\Varid{t}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{aux}\;(\Varid{o},[\mskip1.5mu \mskip1.5mu])\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{aux}\;(\Varid{o},(\Varid{a},\Varid{b})\mathbin{:}\Varid{t})\mathrel{=}\Varid{singl}\;((\Varid{o}\plus \Varid{a}),\Varid{b})\plus \Varid{aux}\;(\Varid{o},\Varid{t}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{dic\char95 rd}\;\Varid{p}\;\Varid{t}\mathrel{=}\Varid{look}\;\Varid{p}\;(\Varid{dic\char95 exp}\;\Varid{t}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{dic\char95 in}\;\Varid{p}\;\Varid{s}\;\Varid{d}\mathrel{=}\Varid{dic\char95 imp}\;(\Varid{collect}\;(\Varid{insert}\;(\Varid{p},\Varid{s})\;(\Varid{discollect}\;(\Varid{dic\char95 exp}\;\Varid{d})))){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\Varid{g1}}{\Varid{g2}}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g1}\;()\mathrel{=}\Conid{Nothing}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g2}\;(\Varid{a},(\Varid{e},\Conid{Nothing}))\mathrel{=}\Conid{Just}\;\Varid{a}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g2}\;(\Varid{a},(\Varid{e},\Varid{d}))\mathrel{=}\Varid{d}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g2}\;(\Varid{a},(\Conid{Nothing},\Varid{d}))\mathrel{=}\Conid{Just}\;\Varid{a}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g2}\;(\Varid{a},(\Varid{e},\Varid{d}))\mathrel{=}\Varid{e}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{insOrd'}\;\Varid{x}\mathrel{=}\Varid{cataBTree}\;\Varid{g}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\conj{\Varid{h}}{\Varid{k}}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{h}\;(i_1\;())\mathrel{=}\Conid{Node}\;(\Varid{x},(\Conid{Empty},\Conid{Empty})){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{h}\;(i_2\;(\Varid{a},((\Varid{ne},\Conid{Empty}),(\Varid{nd},\Conid{Empty}))))\mid \Varid{x}\mathbin{<}\Varid{a}\mathrel{=}\Conid{Node}\;(\Varid{a},(\Conid{Node}\;(\Varid{x},(\Conid{Empty},\Conid{Empty})),\Conid{Empty})){}\<[E]%
\\
\>[9]{}\hsindent{38}{}\<[47]%
\>[47]{}\mid \Varid{x}\mathbin{>}\Varid{a}\mathrel{=}\Conid{Node}\;(\Varid{a},(\Conid{Empty},\Conid{Node}\;(\Varid{x},(\Conid{Empty},\Conid{Empty})))){}\<[E]%
\\
\>[9]{}\hsindent{38}{}\<[47]%
\>[47]{}\mid \Varid{otherwise}\mathrel{=}\Conid{Node}\;(\Varid{a},(\Conid{Empty},\Conid{Empty})){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{h}\;(i_2\;(\Varid{a},((\Varid{ne},\Varid{e}),(\Varid{nd},\Varid{d}))))\mid \Varid{x}\mathbin{>}\Varid{a}\mathrel{=}\Conid{Node}\;(\Varid{a},(\Varid{e},\Varid{nd})){}\<[E]%
\\
\>[9]{}\hsindent{30}{}\<[39]%
\>[39]{}\mid \Varid{x}\mathbin{<}\Varid{a}\mathrel{=}\Conid{Node}\;(\Varid{a},(\Varid{ne},\Varid{d})){}\<[E]%
\\
\>[9]{}\hsindent{30}{}\<[39]%
\>[39]{}\mid \Varid{otherwise}\mathrel{=}\Conid{Node}\;(\Varid{a},(\Varid{e},\Varid{d})){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{k}\;(i_1\;())\mathrel{=}\Conid{Empty}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{k}\;(i_2\;(\Varid{a},((\Varid{ne},\Varid{e}),(\Varid{nd},\Varid{d}))))\mathrel{=}\Conid{Node}\;(\Varid{a},(\Varid{e},\Varid{d})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{insOrd}\;\Varid{a}\;\Varid{x}\mathrel{=}\p1\;(\Varid{insOrd'}\;\Varid{a}\;\Varid{x}){}\<[E]%
\\[\blanklineskip]%
...
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{h}\;(i_1\;())\mathrel{=}\Conid{True}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{h}\;(i_2\;(\Varid{a},((\Varid{be},\Varid{e}),(\Varid{bd},\Varid{d}))))\mathrel{=}\Varid{be}\mathrel{\wedge}\Varid{bd}\mathrel{\wedge}\Varid{auxE}\;\Varid{a}\;\Varid{e}\mathrel{\wedge}\Varid{auxD}\;\Varid{a}\;\Varid{d}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{k}\;(i_1\;())\mathrel{=}\Conid{Empty}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{k}\;(i_2\;(\Varid{a},((\Varid{be},\Varid{e}),(\Varid{bd},\Varid{d}))))\mathrel{=}\Conid{Node}\;(\Varid{a},(\Varid{e},\Varid{d})){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{auxE}\;\Varid{a}\;\Conid{Empty}\mathrel{=}\Conid{True}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{auxE}\;\Varid{a}\;(\Conid{Node}\;(\Varid{b},\Varid{t}))\mathrel{=}\Varid{a}\mathbin{>}\Varid{b}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{auxD}\;\Varid{a}\;\Conid{Empty}\mathrel{=}\Conid{True}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{auxD}\;\Varid{a}\;(\Conid{Node}\;(\Varid{b},\Varid{t}))\mathrel{=}\Varid{a}\mathbin{<}\Varid{b}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{rrot}\;(\Conid{Node}\;(\Varid{a},(\Conid{Node}\;(\Varid{e},(\Varid{ee},\Varid{ed})),\Varid{d})))\mathrel{=}\Conid{Node}\;(\Varid{e},(\Varid{ee},\Conid{Node}\;(\Varid{a},(\Varid{ed},\Varid{d})))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{lrot}\;\Conid{Empty}\mathrel{=}\Conid{Empty}{}\<[E]%
\\
\>[B]{}\Varid{lrot}\;(\Conid{Node}\;(\Varid{a},(\Varid{e},\Conid{Empty})))\mathrel{=}\Conid{Node}\;(\Varid{a},(\Varid{e},\Conid{Empty})){}\<[E]%
\\
\>[B]{}\Varid{lrot}\;(\Conid{Node}\;(\Varid{a},(\Varid{e},\Conid{Node}\;(\Varid{d},(\Varid{de},\Varid{dd})))))\mathrel{=}\Conid{Node}\;(\Varid{d},(\Conid{Node}\;(\Varid{a},(\Varid{e},\Varid{de})),\Varid{dd})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{splay}\;\Varid{l}\;\Varid{t}\mathrel{=}{}\<[14]%
\>[14]{}\Varid{cataList}\;\Varid{g}\;\Varid{l}\;\Varid{t}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\Varid{g1}}{\Varid{g2}}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g1}\;()\;\Varid{t}\mathrel{=}\Varid{t}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g2}\;(\Varid{h},\Varid{t1})\;\Conid{Empty}\mathrel{=}\Conid{Empty}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g2}\;(\Varid{h},\Varid{t1})\;(\Conid{Node}\;(\Varid{a},(\Varid{e},\Varid{d})))\mathrel{=}\mathbf{if}\;(\Varid{h}\equiv \Conid{False})\;\mathbf{then}\;\Varid{t1}\;\Varid{d}\;\mathbf{else}\;\Varid{t1}\;\Varid{e}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\mathrel{=}\alt{\Conid{Leaf}}{\Varid{g2}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g2}\;(\Varid{s},(\Varid{e},\Varid{d}))\mathrel{=}\Conid{Fork}\;(\Varid{e},\Varid{d}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{inBdt}\mathrel{=}\alt{\Conid{Dec}}{\Conid{Query}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{outBdt}\;(\Conid{Dec}\;\Varid{a}){}\<[28]%
\>[28]{}\mathrel{=}i_1\;\Varid{a}{}\<[E]%
\\
...
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g2}\;(\Varid{e},\Varid{d})\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}\Conid{Fork}\;(\Varid{e}\;[\mskip1.5mu \mskip1.5mu],\Varid{d}\;[\mskip1.5mu \mskip1.5mu]){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g2}\;(\Varid{e},\Varid{d})\;(\Varid{h}\mathbin{:}\Varid{t})\mathrel{=}\mathbf{if}\;(\Varid{h}\equiv \Conid{False})\;\mathbf{then}\;(\Varid{d}\;\Varid{t})\;\mathbf{else}\;(\Varid{e}\;\Varid{t}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
    \ensuremath{\mathrm{1}\mathbin{+}((\Conid{Bdt}\;\Varid{a})\times(\Conid{Bdt}\;\Varid{a}))}
           \ar[l]_-{\ensuremath{\Varid{inBdt}}}
\\
     \ensuremath{\mathit B}
           \ar[r]^-{\ensuremath{\Varid{g}}}
           \ar[u]_-{\ensuremath{\Varid{anaBdt}\;\Varid{g}}}
&
     \ensuremath{\mathrm{1}\mathbin{+}\mathit B}
           \ar[u]_-{\ensuremath{\Varid{id}\mathbin{+}((\Varid{anaBdt}\;\Varid{g})\times(\Varid{anaBdt}\;\Varid{g}))}}
}
\end{eqnarray*}
...
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g2}\;(\Varid{e},\Varid{d})\;\Conid{Empty}\mathrel{=}\Conid{Fork}\;(\Varid{e}\;\Conid{Empty},\Varid{d}\;\Conid{Empty}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g2}\;(\Varid{e},\Varid{d})\;(\Conid{Node}\;(\Varid{a},(e_1 ,\Varid{d1})))\mathrel{=}\mathbf{if}\;(\Varid{a}\equiv \Conid{False})\;\mathbf{then}\;(\Varid{d}\;\Varid{d1})\;\mathbf{else}\;(\Varid{e}\;e_1 ){}\<[E]%
\\[\blanklineskip]%
...
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g1}\;\Varid{a}\;\Varid{p}\mathrel{=}\Conid{D}\;[\mskip1.5mu (\Conid{Leaf}\;\Varid{a},\mathrm{1})\mskip1.5mu]{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g2}\;(\Varid{e},\Varid{d})\;\Conid{Empty}\mathrel{=}\Varid{\Conid{Probability}.cond}\;(\Conid{D}\;[\mskip1.5mu \mskip1.5mu])\;(\Varid{e}\;\Conid{Empty})\;(\Varid{d}\;\Conid{Empty}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g2}\;(\Varid{e},\Varid{d})\;(\Conid{Node}\;(\Varid{dist},(e_1 ,\Varid{d1})))\mathrel{=}\Varid{\Conid{Probability}.cond}\;(\Varid{dist})\;(\Varid{e}\;e_1 )\;(\Varid{d}\;\Varid{d1}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
